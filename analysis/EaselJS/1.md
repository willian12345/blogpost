...
事儿还得从 Flash 说起，因为我最早接触的就是 Flash, 是从 Flash 吸引才入行编程的

Flash 最早的脚本是 Actionscript2.0 反正 1.0 我是没用过。

Actionscript2.0 与 Javascript 非常像当然是 es3 时代的 Javascript
